...
public final class DocType {
     ...
     *
     * ★ 판정이 화면이 아니라 여기 있는 이유: 스크립트에 "EXPENSE 나 PURCHASE 면
     *   보인다"를 적으면 유형을 추가할 때 화면도 같이 고쳐야 하는데 그것을
     *   강제하는 장치가 없다. 대신 선택 상자의 각 항목이 자기 성격을 data 속성으로
     *   들고 가고, 스크립트는 고른 항목의 속성을 읽기만 한다.
     */
