...
/**
 * 일별 근태. 연차 반영은 upsertForLeave 만 썼다. 출퇴근 등록의
...
public interface AttendanceMapper {
    ...
    /**
     * 연차 반영 UPSERT. 그날 행이 이미 있을 수 있다 — 오전에
     ...
     * "이미 있으면 조용히 덮어쓰기"가 출근 등록에는 맞지 않는다.
     */
    ...
    /**
     * "부서 근태 현황" — 주어진 deptId 목록(본인 부서 + 하위 전체, 호출자가
    ...
    /**
     * 팀 가동률 - deptId 에 속한 재직 사원 수와, 그 중 date 에
