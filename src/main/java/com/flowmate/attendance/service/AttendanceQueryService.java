...
/**
 * 근태 조회 — 개인/부서. 쓰기(AttendanceService)와 분리한
...
public class AttendanceQueryService {
     ...
     *
     * ★ 권한: viewerDeptId 는 컨트롤러가 로그인 주체의 deptId 를
    ...
    /**
     * 특정 날짜의 팀 가동률(연차 맥락 패널). {@code ai}/{@code approval}
     ...
     * 연차 맥락 패널의 조회를 위해 findMyMonthly 와 별개로 둔다.
