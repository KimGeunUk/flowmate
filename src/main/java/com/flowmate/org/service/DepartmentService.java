...
public class DepartmentService {
     ...
     * org 모듈이 approval 의 타입을 알지 않게 하려는 것이다.
     */
    @Transactional(readOnly = true)
